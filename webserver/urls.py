...
urlpatterns = [
    ...
    path('insertArriveRetour/', views.insertArriveRetour, name='insertArriveRetour'),
    path('', views.home, name='home'),
    path('getall', views.get_all_data, name='getall'),
    path('logout', views.logout_view, name='logout'),
    path('login', views.login_view, name='login'),
    path('delArrivEmp', views.delArrivEmp, name='delArrivEmp'),
    ...
    path('detailsAccess', views.detailsAccess, name='detailsAccess'),
   ...
   # path('<str:string>', views.error404, name='error404'),
